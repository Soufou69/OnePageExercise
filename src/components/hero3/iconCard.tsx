import {rectVert,gridRect,circleVert} from '../../styles/global.css'
export default function IconCard(){
    return(
        <div style={{position:'relative', top:'53%', left:'9%'}}>
            <div className={gridRect}>
                <div className={rectVert}></div>
                <div className={rectVert}></div>
                <div className={rectVert}></div>
                <div className={rectVert}></div>
            </div>
            <div className={circleVert}>
<svg fill="#487F66" width="35" height="35" version="1.1" id="lni_lni-save" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
<g>
